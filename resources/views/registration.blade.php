                    ...
                    <div class="col md-6 right-box">
                        <div class="row align-items-center">
                            ...
                            <div class="input-group mb-1">
                                <input type="text" class="form-control from-control-lg bg-light fs-6"  name="username" id="username" placeholder="Username">
                            </div>
                            <div class="input-group mb-1">
                                <input type="text" class="form-control from-control-lg bg-light fs-6" name="email" id="email" placeholder="Email Address">
                            </div>
                            <div class="input-group mb-1">
                                <input type="password" class="form-control from-control-lg bg-light fs-6" name="password" id="password" placeholder="Password">
                            </div>
